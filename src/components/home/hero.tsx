...
const Hero = () => {
  ...
  return (
    <div className="h-[850px] relative w-full flex items-center justify-start HeroBackground overflow-hidden">
      {/* Start of Hero Slider */}
      <div className="absolute top-0 right-0 w-[750px] h-[850px]">
      ...
      <div className="container mx-auto">
        ...
        <h1 className="mont-bold text-6xl text-white">
        ...
        <p className="text-white mont-semibold mt-4 leading-[30px] text-2xl">
          We provide personalised treatment & recovery <br />
